...
abstract class ListTableAbstract extends \WP_List_Table {
	...
	public function no_items() {
		esc_html_e( 'Nothing in the queue. Please visit your website\'s pages, the visited pages are automatically processed.', 'shortpixel-critical-css' );
	}
	...
	protected function get_bulk_actions() {
		return [
			'purge' => __( 'Purge', 'shortpixel-critical-css' ),
		];
	}
